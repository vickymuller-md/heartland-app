...
export function TrackAssignment({ clinicalIntegrationEnabled = false }: { clinicalIntegrationEnabled?: boolean }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {clinicalIntegrationEnabled && <div className="border-t pt-6 print:hidden">
