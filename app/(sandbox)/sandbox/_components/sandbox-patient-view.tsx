...
export function SandboxPatientView({ patient, patientCheckIns, onCheckIn }: {
  ...
  const tasks = [
    ...
    { id: `${patient.id}-symptoms`, icon: HeartPulse, title: 'Complete symptom check-in', detail: 'Short, plain-language questions with red-flag routing' },
